<?php
	...
	if($_POST)
	{
		$q = "INSERT INTO Feedback VALUES (NULL,'$_POST[name]','$_POST[email]','$_POST[message]')";
		$r = mysqli_query($dbc, $q);
		if($r)
		{?>
			<div class="alert alert-success alert-dismissible" role="alert">
			  <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
			  <strong>Success!</strong><?php echo "<p> Successfully submitted your feedback.<p>" ?>
			</div>
		<?php }
		else
		{?>
			<div class="alert alert-warning alert-dismissible" role="alert">
			  <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
			  <strong>Warning!</strong><?php echo"<p> Could not submit your feedback</p>".mysqli_error($dbc);?>
			</div>
		<?php }
	}
?>
