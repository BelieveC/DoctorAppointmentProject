<?php
	...
	if($_POST)
	{
		...
		$_POST[date] = $new_format;

		$q = "INSERT INTO Appointment VALUES (NULL,'$_POST[name]','$_POST[email]','$_POST[phone]','$_POST[date]','$_POST[type]')";
		$r = mysqli_query($dbc, $q);
		if($r)
		{?>
			<div class="alert alert-success alert-dismissible" role="alert">
			  <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
			  <strong>Success!</strong><?php echo "<p> Successfully booked your appointment<p>" ?>
			</div>
		<?php }
		else
		{?>
			<div class="alert alert-warning alert-dismissible" role="alert">
			  <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
			  <strong>Warning!</strong><?php echo"<p> Could not book your appointment</p>".mysqli_error($dbc);?>
			</div>
		<?php }
	}
?>
					...
					<form action="index.php" method="post">
						...
						<div class="agileits_reservation_grid">
							...
							<div class="span1_of_1 section_room">
								<!-- start_section_room -->
								<span class="glyphicon glyphicon-user" aria-hidden="true"></span>
								<select id="country1" name="type" class="frm-field sect" required>
